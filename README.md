...
### 3.1 Nomenclatura
<ul><li>As variáveis e métodos devem ter nomes auto explicativos.
<li>Todas as variáveis devem ter o nome em inglês.
</ul>
...
### 3.4 Práticas de Programação
<ul><li>Não estamos utilizando nenhuma prática de programação específica.
</ul>
...
<ul><li>Os testes recebem o mesmo nome dos arquivos que ele testa, adicionando o sufixo **.spec**.</ul>
...
<ul><li>Especifique as URLs relativas aos componentes com o prefixo **./**.</ul>
...
<ul><li>Use **@Input()** e **@Output()** para referenciar a propriedade da classe. Escreva na mesma linha.</ul>
...
## 5. Guia de Estilo Python

### 5.1 Layout do código
...
### 5.5 Codificação do Arquivo de Origem
...
https://google.github.io/styleguide/htmlcssguide.html (guia de estilo do HTML)
https://github.com/agis/git-style-guide (guia de estilo do git)
https://github.com/airbnb/javascript (guia de estilo do javascript)
